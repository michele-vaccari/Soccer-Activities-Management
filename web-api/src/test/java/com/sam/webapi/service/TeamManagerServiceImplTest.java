...
class TeamManagerServiceImplTest {
	...
	void whenGetTeamManagers_ThenOperationIsSuccessful() {
		...
		var teamManagerServiceImpl = new TeamManagerServiceImpl(teamManagersRepository, registeredUserRepository, userRepository);
	...
	void whenGetTeamManager_ThenOperationIsSuccessful() {
		...
		var expectedResult = new TeamManagerDto(2, "John", "Doe", "john.doe@sam.com", null, "Y", "123456789", "Street");
		var teamManagerServiceImpl = new TeamManagerServiceImpl(teamManagerRepository, registeredUserRepository, userRepository);
	...
	void whenCreateTeamManager_ThenOperationIsSuccessful() {
		...
		var registeredUserRepository = Mockito.mock(RegisteredUserRepository.class);
		var userRepository = Mockito.mock(UserRepository.class);
		var teamManagerDto = new TeamManagerDto(0, "John", "Doe", "john.doe@sam.com", "Password01", null, "123456789","Street");
	...
	void whenUpdateTeamManager_ThenOperationIsSuccessful() {
		...
		var registeredUserRepository = Mockito.mock(RegisteredUserRepository.class);
		var userRepository = Mockito.mock(UserRepository.class);
		var teamManagerDto = new TeamManagerDto(0, "Jasmine", "Doe", "jasmine.doe@sam.com", null, "Y", "123456789","Street");
		var user = new User(2, "TeamManager", "John", "Doe", "john.doe@sam.com", "Password01", "Y");
		var registeredUser = new RegisteredUser(2,1,"123456789","Street");
		var teamManager = new TeamManager(2);
	...
	@Test
	@DisplayName("When update team manager, then throw RefereeNotFoundException")
