...
class TeamManagerServiceImplTest {
	...
	void whenGetTeamManagers_ThenOperationIsSuccessful() {
		...
		teamManagerServiceImpl.getTeamManagers("john.doe@sam.com");

		Mockito.verify(teamManagersRepository, times(1)).findAll();
		Assertions.assertEquals(expectedResult, teamManagerServiceImpl.getTeamManagers("john.doe@sam.com"));
	}

	@Test
	@DisplayName("When get team managers, then throw UnauthorizedException")
	void whenGetTeamManagers_ThenThrowUnauthorizedException() {
		var teamManagersRepository = Mockito.mock(TeamManagerRepository.class);
		var registeredUserRepository = Mockito.mock(RegisteredUserRepository.class);
		var userRepository = Mockito.mock(UserRepository.class);
		...
		Assertions.assertThrows(UnauthorizedException.class, ()-> teamManagerServiceImpl.getTeamManagers("john.doe@sam.com"));
	...
	void whenGetTeamManager_ThenOperationIsSuccessful() {
		...
		var result = teamManagerServiceImpl.getTeamManager(1, "john.doe@sam.com");
	...
	@Test
	@DisplayName("When get team manager, then throw UnauthorizedException")
	void whenGetTeamManager_ThenThrowUnauthorizedException() {
		var teamManagersRepository = Mockito.mock(TeamManagerRepository.class);
		var registeredUserRepository = Mockito.mock(RegisteredUserRepository.class);
		var userRepository = Mockito.mock(UserRepository.class);
		Mockito.when(userRepository.findByEmailAndActive("john.doe@sam.com", "Y")).thenReturn(null);
		...
		Assertions.assertThrows(UnauthorizedException.class, ()-> teamManagerServiceImpl.getTeamManager(1,"john.doe@sam.com"));
		Mockito.verify(userRepository, times(1)).findByEmailAndActive("john.doe@sam.com", "Y");
	}
	...
	void whenGetTeamManager_ThenThrowTeamManagerNotFoundException() {
		...
		Assertions.assertThrows(TeamManagerNotFoundException.class, ()-> teamManagerServiceImpl.getTeamManager(1, "john.doe@sam.com"));
		Mockito.verify(teamManagerRepository, times(1)).findById(1);
	}
	...
	@Test
	@DisplayName("When create team manager, then throw UnauthorizedException")
	void whenCreateTeamManager_ThenThrowUnauthorizedException() {
		var teamManagerRepository = Mockito.mock(TeamManagerRepository.class);
		var registeredUserRepository = Mockito.mock(RegisteredUserRepository.class);
		var userRepository = Mockito.mock(UserRepository.class);
		var teamRepository = Mockito.mock(TeamRepository.class);
		...
		Assertions.assertThrows(UnauthorizedException.class, ()-> teamManagerServiceImpl.createTeamManager(adminUser.getEmail(), teamManagerDto));
	...
	void whenUpdateTeamManager_ThenOperationIsSuccessful() {
		...
		teamManagerServiceImpl.updateTeamManager(id, teamManagerDto, "john.doe@sam.com");
	...
	@Test
	@DisplayName("When update team manager, then throw UnauthorizedException")
	void whenUpdateTeamManager_ThenThrowUnauthorizedException() {
		var teamManagersRepository = Mockito.mock(TeamManagerRepository.class);
		var registeredUserRepository = Mockito.mock(RegisteredUserRepository.class);
		var userRepository = Mockito.mock(UserRepository.class);
		Mockito.when(userRepository.findByEmailAndActive("john.doe@sam.com", "Y")).thenReturn(null);
		...
		Assertions.assertThrows(UnauthorizedException.class, ()-> teamManagerServiceImpl.updateTeamManager(id, teamManagerDto, "john.doe@sam.com"));
		Mockito.verify(userRepository, times(1)).findByEmailAndActive("john.doe@sam.com", "Y");
	}
	...
	void whenUpdateTeamManager_ThenThrowUserNotFoundException() {
		...
		Assertions.assertThrows(UserNotFoundException.class, ()-> teamManagerServiceImpl.updateTeamManager(id, teamManagerDto, "john.doe@sam.com"));
		Mockito.verify(userRepository, times(1)).findById(id);
	}
	...
	void whenUpdateTeamManager_ThenThrowRegisteredUserNotFoundException() {
		...
		Assertions.assertThrows(RegisteredUserNotFoundException.class, ()-> teamManagerServiceImpl.updateTeamManager(id, teamManagerDto, "john.doe@sam.com"));
		Mockito.verify(userRepository, times(1)).findById(id);
		Mockito.verify(registeredUserRepository, times(1)).findById(id);
	}
	...
	void whenUpdateTeamManager_ThenThrowTeamManagerNotFoundException() {
		var teamManagerRepository = Mockito.mock(TeamManagerRepository.class);
		var registeredUserRepository = Mockito.mock(RegisteredUserRepository.class);
		var userRepository = Mockito.mock(UserRepository.class);
		Mockito.when(userRepository.findByEmailAndActive("john.doe@sam.com","Y")).thenReturn(
		...
		Assertions.assertThrows(TeamManagerNotFoundException.class, ()-> teamManagerServiceImpl.updateTeamManager(id, teamManagerDto, "john.doe@sam.com"));
		Mockito.verify(userRepository, times(1)).findById(id);
		Mockito.verify(registeredUserRepository, times(1)).findById(id);
		Mockito.verify(teamManagerRepository, times(1)).findById(id);
	}
	...
	void whenUpdateTeamManager_ThenThrowTeamNotFoundException() {
		...
		Assertions.assertThrows(TeamNotFoundException.class, ()-> teamManagerServiceImpl.updateTeamManager(id, teamManagerDto, "john.doe@sam.com"));
		Mockito.verify(userRepository, times(1)).findById(id);
		Mockito.verify(registeredUserRepository, times(1)).findById(id);
		Mockito.verify(teamManagerRepository, times(1)).findById(id);
	}
	...
	void whenUpdateTeamManager_ThenThrowSingleEmailConstraintException() {
		...
		Assertions.assertThrows(SingleEmailConstraintException.class, ()-> teamManagerServiceImpl.updateTeamManager(id, teamManagerDto, "john.doe@sam.com"));
		Mockito.verify(userRepository, times(1)).findById(id);
		Mockito.verify(registeredUserRepository, times(1)).findById(id);
		Mockito.verify(teamManagerRepository, times(1)).findById(id);
		Mockito.verify(teamRepository, times(1)).findByTeamManagerId(id);
	...
	void whenDeleteTeamManager_ThenOperationIsSuccessful() {
		...
		teamManagerServiceImpl.deleteTeamManager(id, "john.doe@sam.com");
	...
	@Test
	@DisplayName("When delete team manager, then throw UnauthorizedException")
	void whenDeleteTeamManager_ThenThrowUnauthorizedException() {
		var teamManagersRepository = Mockito.mock(TeamManagerRepository.class);
		var registeredUserRepository = Mockito.mock(RegisteredUserRepository.class);
		var userRepository = Mockito.mock(UserRepository.class);
		Mockito.when(userRepository.findByEmailAndActive("john.doe@sam.com", "Y")).thenReturn(null);
		...
		Assertions.assertThrows(UnauthorizedException.class, ()-> teamManagerServiceImpl.deleteTeamManager(1, "john.doe@sam.com"));
		Mockito.verify(userRepository, times(1)).findByEmailAndActive("john.doe@sam.com", "Y");
	}
	...
	void whenDeleteTeamManager_ThenThrowTeamManagerNotFoundException() {
		...
		Assertions.assertThrows(TeamManagerNotFoundException.class, ()-> teamManagerServiceImpl.deleteTeamManager(id, "john.doe@sam.com"));
		Mockito.verify(teamManagerRepository, times(1)).existsById(id);
	}
	...
	void whenDeleteTeamManager_ThenThrowRegisteredUserNotFoundException() {
		...
		Assertions.assertThrows(RegisteredUserNotFoundException.class, ()-> teamManagerServiceImpl.deleteTeamManager(id, "john.doe@sam.com"));
		Mockito.verify(teamManagerRepository, times(1)).existsById(id);
	}
	...
	void whenDeleteTeamManager_ThenThrowUserNotFoundException() {
		...
		Assertions.assertThrows(UserNotFoundException.class, ()-> teamManagerServiceImpl.deleteTeamManager(id, "john.doe@sam.com"));
		Mockito.verify(teamManagerRepository, times(1)).existsById(id);
		Mockito.verify(userRepository, times(1)).existsById(id);
	}
}